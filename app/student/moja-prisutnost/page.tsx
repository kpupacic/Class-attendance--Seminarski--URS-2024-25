  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-blue-600">Pregled Moje Prisutnosti</h1>
        <Link href="/student">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          <FilterForm title="Pregled Moje Prisutnosti" onSubmit={handleFilter} buttonText="Filtriraj" />
        </div>

        {currentFilters && (
          <div>
            <AttendanceResults records={filteredRecords} filters={currentFilters} />
          </div>
        )}
      </div>
